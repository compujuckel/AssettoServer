...
public class AiParams
{
    ...
    [YamlMember(Description = "Tyre diameter of AI cars, shouldn't have to be changed unless some cars are creating lots of smoke.")]
    public float TyreDiameter { get; set; } = 0.65f;
...
public class CarSpecificOverrides
{
    ...
    [YamlMember(Description = "Tyre diameter of AI cars, shouldnt  have to be changed, unless cars are creating lots of smoke.")]
