    ...
    public class AiParams
        {
            ...
            public int StateSafetyDistance { get; set; } = 2000;
            ...
            [JsonIgnore]
            public int MinAiSafetyDistanceSquared => MinAiSafetyDistance * MinAiSafetyDistance;
            [JsonIgnore]
            public int MaxAiSafetyDistanceSquared => MaxAiSafetyDistance * MaxAiSafetyDistance;
            [JsonIgnore]
            public int StateSafetyDistanceSquared => StateSafetyDistance * StateSafetyDistance;
            [JsonIgnore]
            public float SpawnSafetyDistanceToPlayerSquared => SpawnSafetyDistanceToPlayer * SpawnSafetyDistanceToPlayer;
            [JsonIgnore]
            public int MinSpawnProtectionTimeMilliseconds => MinSpawnProtectionTime * 1000;
            [JsonIgnore]
            public int MaxSpawnProtectionTimeMilliseconds => MaxSpawnProtectionTime * 1000;
            [JsonIgnore]
