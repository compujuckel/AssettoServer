...
public static class EventHandlerExtensions
{
    ...
    extension<TSender, TArgs>(EventHandler<TSender, TArgs>? eventHandler) where TArgs : DeferredEventArgs
    {
        /// <summary>
        ...
        public Task InvokeAsync(TSender sender, TArgs eventArgs)
        {
        ...
        /// <returns><see cref="Task"/> to wait on deferred event handler.</returns>
        public Task InvokeAsync(TSender sender, TArgs eventArgs, CancellationToken cancellationToken)
        {
