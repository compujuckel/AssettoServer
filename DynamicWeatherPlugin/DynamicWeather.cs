...
public class DynamicWeather : CriticalBackgroundService, IAssettoServerAutostart
{
    ...
    private readonly DynamicWeatherConfiguration _configuration;
    private readonly List<WeatherWeight> _weathers = new();

    public DynamicWeather(DynamicWeatherConfiguration configuration, WeatherManager weatherManager, IWeatherTypeProvider weatherTypeProvider, IHostApplicationLifetime applicationLifetime) : base(applicationLifetime)
    {
